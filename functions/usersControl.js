...
async function blockUser(parameters) {
  ...
  throw { blocked: userToBlock.blocked, a: (userToBlock.blocked != undefined), b: (userToBlock.blocked == true), c: (userToBlock.blocked == null), d: (userToBlock.blocked == ``), , user: userToBlock }
